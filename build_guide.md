...
**Note**: it has been reported that cross-compiling might produce builds that fail to launch, despite successfully completing the compile process. The issue seems to be related to the fact that macOS sets an extended attribute that indicates the file as broken on the very first launch. Troubleshooting and discussion about this take place [here](https://gitlab.com/librewolf-community/browser/macos/-/issues/19).
